...
var u {demand in Demands, demandPath in 1..demand_maxPath[demand]}, binary; # Zmienna wyboru ścieżki , binary
...
# Każde żądanie może mieć aktywowane maksymalnie 3 ścieżki
subject to max_paths_per_demand {demand in Demands}:
...
problem dap:
    ...
    path_volume_linking, path_minVolume_constraint, max_paths_per_demand;
